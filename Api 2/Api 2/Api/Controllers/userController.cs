...
/*
 Conexion del servidor local MySQL para una api, despues
se crea un rest framework, donde se usan los servicios GET para
mostrar los datos requeridos de la tabla USER, ademas
un servicio POST para que el usuario agregue la informacion que se le pide
para despues guardar los datos en la tabla de MySQL.
 */
